...
const CompatibilityScoreWithResume: React.FC<CompatibilityScoreWithResumeProps> = ({ language = 'fr' }) => {
  ...
  const translations: Record<Language, Record<string, string>> = {
    fr: {
      ...
      requirementsPlaceholder: 'Entrez les exigences techniques du poste...',
      benefits: 'Avantages et Perks',
      benefitsPlaceholder: 'Entrez les avantages et perks du poste...',
      ...
      seniorFrontendTitle: 'Score de Compatibilité avec CV',
      seniorFrontendDesc: 'Évalue la compatibilité en utilisant le CV et la description de poste.'
    },
    en: {
      ...
      requirementsPlaceholder: 'Enter technical requirements for the position...',
      benefits: 'Benefits and Perks',
      benefitsPlaceholder: 'Enter job benefits and perks...',
      calculateScore: 'Calculate Score (with Resume)',
      reset: 'Reset',
      processing: 'Evaluating compatibility (with resume)...',
      processingTime: `This evaluation may take up to ${APP_CONSTANTS.REQUEST_TIMEOUT / 1000} seconds`,
      compatibilityScore: 'Compatibility Score (with Resume)',
      score: 'Score',
      excellent: 'Excellent',
      good: 'Good',
      fair: 'Fair',
      ...
      seniorFrontendTitle: 'Compatibility Score with Resume',
      seniorFrontendDesc: 'Evaluates compatibility using the resume and job description.'
    }
  }
  ...
  return (
    <div className="fade-in">
      <div className="feature-header">
        <h2>{t.seniorFrontendTitle}</h2>
        <p className="feature-description">{t.seniorFrontendDesc}</p>
      </div>
